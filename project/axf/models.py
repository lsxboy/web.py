...
class User(models.Model):
    ...
    passwd  = models.CharField(max_length=200, null=True, default=None)
    ...
    @classmethod
    def create(cls, phoneNum, passwd, token, motto):
        return cls(phoneNum=phoneNum, passwd=passwd, token=token, motto=motto)
...
class Cart(models.Model):
    ...
    def create(cls, user, product, order, num):
        return cls(user=user, product=product, order=order, num=int(num))
