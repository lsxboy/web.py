...
from serial_port_send import SerialPortCommunication as SerialPort
...
class Main:
    ...
    def __init__(self):
        self.Back_Ip = ScreenConfig.local_config()
        self.Ip_Post = ScreenConfig.get_display_config(self.Back_Ip)
    ...
    def listen(self):
        ...
        # 初始化窗口屏
        disp = DisposeData()
        course = disp.make_threading(SerialPort.init_window)
        course.start()
        course.join()
